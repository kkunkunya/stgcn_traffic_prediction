...
class STMatrix(object):
    ...
    def create_dataset(self, len_closeness=33, len_trend=3, TrendInterval=1, len_period=3, PeriodInterval=1):
        ...
        depends = [range(1, len_closeness+1),#1,2,3,...34
                   ...
                   [TrendInterval * self.T * j for j in range(1, len_trend+1)]]#(33,66,99)*0.5
