...
def getparse():
    ...
    #model
    parse.add_argument('-close_size', type=int, default=33)#
    parse.add_argument('-period_size', type=int, default=3)#
    parse.add_argument('-trend_size', type=int, default=1)#type=int, default=1
    parse.add_argument('-test_size', type=int, default=33*2)
    ...
    parse.add_argument('-batch_size', type=int, default=4, help='batch size')#小于15
    parse.add_argument('-se',type=int)
    parse.add_argument('-epoch_size', type=int, default=2, help='epochs')#200
    ...
    # temporal backbone choice
    parse.add_argument('-temporal', type=str, default='transformer', choices=['transformer', 'lstm', 'gru', 'dcnn'],
                       help='temporal backbone for closeness/period branches')
